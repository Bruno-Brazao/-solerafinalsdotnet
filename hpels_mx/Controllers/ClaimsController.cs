...
namespace hpels_mx.Controllers
{
    ...
    {
        private readonly HpelsmxDbContext _context;

        public ClaimsController(HpelsmxDbContext context)
        {
            _context = context;
        }
        ...
        {
            var hpelsmxDbContext = _context.Claims.Include(c => c.Vehicle);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'HpelsmxDbContext.Claims'  is null.");
            }
            var claim = await _context.Claims.FindAsync(id);
            if (claim != null)
            {
